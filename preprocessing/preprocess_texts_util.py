# code adapted from https://github.com/tigerchen52/Biomedical-Entity-Linking/blob/master/source/preprocess_sample.py under Apache License 2.0

## Ab3P needed: Ab3P-v1.5.tar.gz version in https://ftp.ncbi.nlm.nih.gov/pub/wilbur/ 

import re
from nltk import word_tokenize
import pickle

def _load_add_abbr_dict(additional_abbr_dict_fn):
    '''
    load additional abbreviation dictionary from file
    '''
    add_abbr_dict = {}
    with open(additional_abbr_dict_fn,encoding='utf-8') as f_content:
    ...
    for line in doc:
        ...
        add_abbr_dict[abbr] = concept
    return add_abbr_dict
...
def load_number_mapping(number_mapping_file='./number_mapping.txt'):
    '''
...
def preprocess_pipeline(text, ab3p_abbr_dict={}, additional_abbr_dict={}):
    '''
...
if __name__ == "__main__":
    ...
    print(dict_ab3p_abbr)
    #print(expand_abbreviation('cure the AF',additional_abbr_dict=dict_add_abbr))
    text = 'cure the AF for 3 times a day, ASDIR, oh, oh!'
