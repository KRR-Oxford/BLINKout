...
def get_is_men_str_matchable_features(list_mention_input, list_2d_label_input, fuzzy_tolerance=2):
    ...
    for label_sub_token_list in list_2d_label_input:
        ...
        print("-----------")
        print ("label_sub_token_list as follows")
        print(label_sub_token_list)
        # get the position of title mark
        pos_title_mark = label_sub_token_list.index(3)
        print("pos_title_mark as follows")
        print(pos_title_mark)
        ...
        print("label_tit_sub_token_list as follow")
        print(label_tit_sub_token_list)
        # exact matching
        ...
        if mention_matched_fuzzy < 2:
            num_set_diff_men_tit = count_list_set_diff(mention_sub_token_list, label_tit_sub_token_list,
                                                       pair_comparison=True)
            if num_set_diff_men_tit <= fuzzy_tolerance:
                mention_matched_fuzzy += 1

        if mention_matched_fuzzy_w_desc < 2:
            num_set_diff_men_tit_desc = count_list_set_diff(mention_sub_token_list, label_sub_token_list,
                                                            pair_comparison=False)
    ...
    print(mention_matched_exact,mention_matched_exact_w_desc,mention_matched_exact_w_desc,mention_matched_fuzzy,mention_matched_fuzzy,mention_matched_fuzzy_w_desc,mention_matched_fuzzy_w_desc)
    is_men_str_matchable_features = [mention_matchable_exact, mention_matchable_exact_w_desc_one,
                                     mention_matchable_exact_w_desc_several, mention_matchable_fuzzy_one,
                                     mention_matchable_fuzzy_several, mention_matched_fuzzy_w_desc_one,
                                     mention_matchable_fuzzy_w_desc_several]

    print('is_men_str_matchable_features:', is_men_str_matchable_features)
    return get_is_men_str_matchable_features


def get_is_men_str_matchable_features_SVM(list_mention_input, list_2d_label_input, fuzzy_tolerance=2):
    # print("list_mention_input:", len(list_mention_input), list_mention_input)
    # print("label_input:", len(list_2d_label_input), len(list_2d_label_input[0]))
    # print(list_2d_label_input)
    # for mention_sub_token_list in list_2d_mention_input:
    # clean mention input
    # mention_sub_token_list = [sub_token_id for sub_token_id in list_mention_input if sub_token_id >= 3]
    mention_sub_token_list = list_mention_input
    mention_matched_exact = 0
    mention_matched_exact_w_desc = 0
    mention_matched_fuzzy = 0
    mention_matched_fuzzy_w_desc = 0
    for label_sub_token_list in list_2d_label_input:
        ...
        # print(pos_title_mark)
        # get title sub tokens as a list
        label_tit_sub_token_list = label_sub_token_list
        # get desc sub tokens as a list
        # label_desc_sub_token_list = label_sub_token_list[pos_title_mark+1:]
        # print("label_tit_sub_token_list as follow")
        # print(label_tit_sub_token_list)
    ...
    mention_matchable_fuzzy_w_desc_several = mention_matched_fuzzy_w_desc > 1
    # print(mention_matched_exact,mention_matched_exact_w_desc,mention_matched_exact_w_desc,mention_matched_fuzzy,mention_matched_fuzzy,mention_matched_fuzzy_w_desc,mention_matched_fuzzy_w_desc)
    featureScoreList_candidate=[mention_matched_exact,mention_matched_exact_w_desc,mention_matched_exact_w_desc,mention_matched_fuzzy,mention_matched_fuzzy,mention_matched_fuzzy_w_desc,mention_matched_fuzzy_w_desc]
    is_men_str_matchable_features = [mention_matchable_exact, mention_matchable_exact_w_desc_one,
                                     mention_matchable_exact_w_desc_several, mention_matchable_fuzzy_one,
                                     mention_matchable_fuzzy_several, mention_matched_fuzzy_w_desc_one,
                                     mention_matchable_fuzzy_w_desc_several]
    ...
    # print('is_men_str_matchable_features:', is_men_str_matchable_features)
    return featureScoreList_candidate


list_mention_input = [0, 123, 345, 677, 1]
list_2d_label_input = [[123, 345, 677, 688, 3, 32, 324, 566], [321, 123, 124, 677, 688, 3, 32, 324, 566],
                       [123, 345, 3, 32, 324, 566], [666, 677, 678, 3, 32, 324, 566]]

get_is_men_str_matchable_features_SVM(list_mention_input, list_2d_label_input, fuzzy_tolerance=2)