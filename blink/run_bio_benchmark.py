...
if data == 'share_clef':
    ...
    #     bienc_model_name = args_keyed_in.biencoder_model_name #data.replace('_','-') + '-tl-syn'
    #     NIL_enc_mark = args_keyed_in.NIL_enc_mark #'_w_NIL_syn'
    #     #cross_model_setting = 'original'#'original-BM25-top10' #'original_top10'#'original-BM25-w-o-NIL' #'original-w-o-NIL'    
    # else:
    #     bienc_model_name = args_keyed_in.biencoder_model_name #data.replace('_','-') + '-tl-syn-NIL-tag'
    #     NIL_enc_mark = args_keyed_in.NIL_enc_mark
    #     #cross_model_setting = 'original-syn-NIL-tag' #'original-NIL-tag'
    #bi_enc_bert_model = args_keyed_in.biencoder_bert_model
    bienc_model_name = args_keyed_in.biencoder_model_name
    biencoder_model_size = args_keyed_in.biencoder_model_size
    NIL_enc_mark = args_keyed_in.NIL_enc_mark
    #print("NIL_enc_mark in run_bio_benchmark:",NIL_enc_mark)
    #cross_enc_bert_model= args_keyed_in.crossencoder_bert_model
    ...
    if args_keyed_in.debug:
        ...
        DATASETS = [
            ...
            {
                "name": "Share-CLEF_eHealth2013-ori-test",
                "filename": "data/share_clef_2013_preprocessed_ori/test.jsonl", 
            },            
            {
            ...
            #     "filename": "data/share_clef_2013_preprocessed/test_preprocessed.jsonl", 
            # },
        ]
elif data[:2] == 'mm':
    #use_NIL_tag = False
...
for dataset in DATASETS:
    ...
    table.add_row(
        [
            ...
            round(rec_NIL,4),
            round(f1_NIL,4),
            # round(crossencoder_normalized_in_KB_accuracy, 4),
            # round(overall_unormalized_in_KB_accuracy, 4),
            # round(crossencoder_normalized_NIL_accuracy, 4),
            # round(overall_unormalized_NIL_accuracy, 4),
            num_datapoints,
            num_datapoints_in_KB,
            num_datapoints_NIL,
        ]
