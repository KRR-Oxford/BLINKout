...
def main(params):
    ...
    for epoch_idx in trange(int(num_train_epochs), desc="Epoch"):
        ...
        for step, batch in enumerate(iter_):
            ...
            mention_matchable_fts = batch[3]
            loss, _, _ = reranker(context_input, label_input, context_length, label_is_NIL_input=label_is_NIL_input,
                                  use_original_classification=params["use_ori_classification"],
                                  ...
                                  use_score_pooling=params["use_score_pooling"],
                                  use_men_only_score_ft=params["use_men_only_score_ft"],
                                  use_extra_features=params["use_extra_features"],mention_matchable_fts=mention_matchable_fts)
    ...
    if params["evaluate"]:
        ...
        evaluate(params, logger=logger) #TODO: check here
