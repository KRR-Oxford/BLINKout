...
def prepare_crossencoder_data(
    ...
    id2text, ori_local_id2wikipedia_id, local_id2wikipedia_id, topk=100, keep_all=False, filter_within=True, NIL_ent_id=88150, test_NIL_label_only=False, 
    ...
    label_input_list, candidate_input_list,list_is_NIL_labels, label_in_KB_input_list, label_NIL_input_list, nns_filtered, nns_filtered_in_KB, nns_filtered_NIL = prepare_crossencoder_candidates(
        tokenizer, labels, nns, id2title, id2synonyms, 
        id2text, ori_local_id2wikipedia_id, local_id2wikipedia_id, topk=topk, NIL_ent_id=NIL_ent_id, use_extra_id=False,use_NIL_tag=use_NIL_tag,use_NIL_desc=use_NIL_desc,use_NIL_desc_tag=use_NIL_desc_tag,use_synonyms=use_synonyms, #use the extra id will change -1 to len(nn)
    )
